...
public class Buffer {
	public static final String ZIP_ENTRY_NAME = "z";
	...
	static Object fromByteArray(byte[] arr) throws IOException,
	...
	static Object fromZipByteArray(byte[] arr) throws IOException,
			ClassNotFoundException {
		ByteArrayInputStream bufIn = new ByteArrayInputStream(arr);
		try (ZipInputStream zis = new ZipInputStream(bufIn)) {
			ZipEntry zen = zis.getNextEntry();
			if (zen.getName().equals(ZIP_ENTRY_NAME) == false) {
